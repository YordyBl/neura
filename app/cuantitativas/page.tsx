...
export default function CuantitativasPage() {
  const servicios = [
    { title: "ENCUESTAS POR INTERCEPCIÓN" },
    { title: "ENCUESTAS TELEFÓNICAS"},
    { title: "ENCUESTAS ONLINE" },
    { title: "ENCUESTAS HOGARES" },
    { title: "CLIENTE INCOGNITO" },
  ]
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 mb-12">
              <div className="flex-1">
                <p className="text-base sm:text-lg lg:text-xl text-white/90 leading-relaxed">
                  Ya sea para iniciar un proyecto, lanzar una iniciativa, monitorear indicadores o comprender percepciones, contar con un buen diagnóstico es clave. 
                  En NEURA SPRINT ofrecemos herramientas y enfoques que ayudan a enfocar los esfuerzos donde realmente importa, facilitando decisiones más informadas y efectivas.
                </p>
              </div>
