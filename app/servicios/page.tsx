  ...
  return (
    <section className="bg-white">
      <div className="relative isolate py-12 sm:py-16 lg:py-20 min-h-screen">
        {/* Background layers (mismo estilo que Nosotros/Filosofía) */}
        ...
        <div className="relative z-10">
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
            <div className="max-w-6xl mx-auto">
              <header className="mb-12 sm:mb-16 text-start">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-black tracking-tight">
                  Servicios
                </h2>
              </header>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 mb-12">
                <div className="flex-1">
                  <p className="text-base sm:text-lg lg:text-xl text-gray-700 leading-relaxed">
                    Hoy en día las marcas necesitan una sintonía y conexión total con los consumidores, con sus estilos de
                    vida, personalidad, necesidades y emociones, de tal modo que se logre la mejor experiencia con la
                    marca. Entender a los consumidores y sus necesidades es clave para identificar <span className="font-semibold text-black">insights</span> que apoyen el
                    branding, la innovación y la comunicación de las marcas.
                  </p>
                </div>
                <div className="flex-1 flex justify-center lg:justify-end">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                {servicios.map((servicio, index) => (
                  <div
                    key={index}
                    className={`group relative bg-white border border-gray-200 rounded-xl p-6 sm:p-8 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${
                      index === servicios.length - 1 ? "lg:col-span-3" : ""
                    }`}
                  >
                    <div className="relative z-10">
