...
export default function CualitativasPage() {
  const servicios = [
    { title: "ENTREVISTAS A PROFUNDIDAD" },
    { title: "FOCUS GROUP"},
    { title: "COMUNIDADES DIGITALES" },
    { title: "ETNOGRAFÍAS E INMERSIONES" },
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 mb-12">
              <div className="flex-1">
                ...
                Explora sus motivaciones, experiencias y contextos para revelar las dinámicas que influyen en sus decisiones, ya sea en el consumo o en su vida social. 
                Las metodologías cualitativas permiten descubrir sentidos profundos, anticipar desafíos y abordar problemáticas desde su raíz.
                </p>
              </div>
